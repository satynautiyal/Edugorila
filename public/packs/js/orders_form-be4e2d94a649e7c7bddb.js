...
/* WEBPACK VAR INJECTION */(function($) {//Change TotalAmount after of Product
changeTotalAmountProduct = function changeTotalAmountProduct(quantity, price) {
...
changeTotalAmountService = function changeTotalAmountService(changedDuration, defaultDuration, defaultPrice) {
  var newPrice = defaultPrice / defaultDuration * changedDuration;
  $("#total_amount_div").html(newPrice.toFixed(2));
  $("#total_amount_hidden").val(newPrice.toFixed(2));
...
setTime = function setTime(startTime, endTime) {
  ...
  $("button-services").html("<%= form.submit 'Add To Cart',id: 'button_add_to_cart', class: 'appearance-none w-28 bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:opacity-70 focus:outline-none focus:border-gray-500', name:'cart' %><button type='button' id='button_buynow' class= 'appearance-none w-28 bg-green-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-500 focus:opacity-70 focus:outline-none focus:border-gray-500' onclick='redirectToPayment(<%=ordered.id%>,<%=ordered.name%>,<%=ordered.price %>)'>Buy now</button>");
};
...
/******/ });
//# sourceMappingURL=orders_form-be4e2d94a649e7c7bddb.js.map