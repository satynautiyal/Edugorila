...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/payment_buy.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/payment_buy.js":
/*!*********************************************!*\
  !*** ./app/javascript/packs/payment_buy.js ***!
  \*********************************************/
...
/* WEBPACK VAR INJECTION */(function($) {redirectToPayment = function redirectToPayment(id, name, price) {
  if ($("#quantity").val() != undefined) {
    var quantity = $("#quantity").val();
    var amount = price;
    var ordered_type = "ProductVariant";
  } else {
    var quantity = 1;
  ...
  $.ajax({
    type: "get",
    data: "id=" + id + "&name=" + name + "&quantity=" + quantity + "&duration=" + duration + "&start_time=" + start_time + "&end_time=" + end_time + "&amount=" + amount + "&ordered_type=" + ordered_type + "&date=" + date,
    url: "../payment/one_item_payment",
...
/******/ });
//# sourceMappingURL=payment_buy-f189d0a1a37cb2909e12.js.map