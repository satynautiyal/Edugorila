...
changeTotalAmountService = function changeTotalAmountService(changedDuration, defaultDuration, defaultPrice) {
  ...
  $("#total_amount_div").html(newPrice);
  $("#total_amount_hidden").val(newPrice);
...
setTime = function setTime(startTime, endTime) {
  ...
  $("#button_add_to_cart").attr("class", "btn btn-primary");
  $("#button_buynow").attr("class", "btn btn-success");
};
...
/******/ });
//# sourceMappingURL=orders_form-7f2bf1ebd3f0ea010eea.js.map