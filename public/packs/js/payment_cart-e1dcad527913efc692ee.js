...
/* WEBPACK VAR INJECTION */(function($) {redirectToPayment = function redirectToPayment(id, cartData) {
  $.ajax({
    type: "get",
    data: "id=" + id + ",&cart_data=" + cartData + "&name=cart&quantity=1",
...
/******/ });
//# sourceMappingURL=payment_cart-e1dcad527913efc692ee.js.map