...
update_service_popup = function update_service_popup(order_id, date, default_duration, start_time, end_time, default_price, order_duration) {
  ...
  endTime = end_time;
  totalAmount = (defaultPrice / defaultDuration * orderedDuration).toFixed(1);
  $("#update_service").show();
...
$("#date_in_popup, #duration_in_popup").on("change", function () {
  ...
  totalAmount = (defaultPrice / defaultDuration * duration).toFixed(1);
  $.ajax({
    url: "../orders/time_slot",
...
/******/ });
//# sourceMappingURL=cart_index-a20da9b476bb10142c4f.js.map