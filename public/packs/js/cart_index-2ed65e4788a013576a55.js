...
update_service = function update_service() {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      $("#start_time" + orderId).html(final_startTime);
      $("#end_time" + orderId).html(final_endTime);
...
buyButtonDisable = function buyButtonDisable() {
  $("#buyButton").attr("class", "btn btn-primary disabled");
  var button = $("#buttonBuyNow").html();
  $("#buttonBuyNow").html(button);
};
...
/******/ });
//# sourceMappingURL=cart_index-2ed65e4788a013576a55.js.map