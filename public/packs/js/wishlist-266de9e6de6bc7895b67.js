...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/wishlist.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {addToWishlist = function addToWishlist(productId, userId, urlPath) {
  $(".wishlist-icon").removeClass("fa-heart-o");
  $(".wishlist-icon").addClass("fa-heart");
  $.ajax({
    type: "get",
...
remove_from_wishlist = function remove_from_wishlist(productId, userId, urlPath) {
  $(".wishlist-icon").removeClass("fa-heart");
  $(".wishlist-icon").addClass("fa-heart-o");
  $.ajax({
    type: "get",
    data: "product_variant_id=" + productId + "&user_id=" + userId,
    url: urlPath
...
/******/ });
//# sourceMappingURL=wishlist-266de9e6de6bc7895b67.js.map