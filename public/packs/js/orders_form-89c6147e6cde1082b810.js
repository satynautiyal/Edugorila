...
setTime = function setTime(startTime, endTime) {
  ...
  $("#buy-button-services").html("<button type='button' id='button_buynow' class= 'appearance-none w-28 bg-green-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-500 focus:opacity-70 focus:outline-none focus:border-gray-500' onclick='redirectToPayment(<%=ordered.id%>,<%=ordered.name%>,<%=ordered.price %>)'>Buy now</button>");
};
...
/******/ });
//# sourceMappingURL=orders_form-89c6147e6cde1082b810.js.map