...
setTime = function setTime(startTime, endTime) {
  ...
  $("#button_add_to_cart").attr("class", "appearance-none block w-28 bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:opacity-70 focus:outline-none focus:border-gray-500");
  $("#button_buynow").attr("class", "appearance-none block w-28 bg-green-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-500 focus:opacity-70 focus:outline-none focus:border-gray-500");
};
...
/******/ });
//# sourceMappingURL=orders_form-f5f883a849d1dff1846e.js.map