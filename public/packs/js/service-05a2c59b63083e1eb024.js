...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/service.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/service.js":
/*!*****************************************!*\
  !*** ./app/javascript/packs/service.js ***!
  \*****************************************/
...
/* WEBPACK VAR INJECTION */(function($) {$("#date").on("change", function () {
  $.ajax({
    url: "../orders/time_slot",
    data: "user_date=" + $("#date").val() + "&duration=<%= ordered.duration %>&start_time=<%= ordered.start_time %>&end_time=<%= ordered.end_time %>",
    type: "get",
...
/******/ });
//# sourceMappingURL=service-05a2c59b63083e1eb024.js.map