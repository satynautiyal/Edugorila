...
update_quanatity = function update_quanatity(quantity, orderId, itemPrice) {
  var newPrice = (quantity * itemPrice).toFixed(2);
...
update_service_popup = function update_service_popup(order_id, date, default_duration, start_time, end_time, default_price, order_duration) {
  ...
  endTime = end_time;
  totalAmount = (defaultPrice / defaultDuration * orderedDuration).toFixed(2);
  $("#update_service").css("display", "absolute");
...
/******/ });
//# sourceMappingURL=cart_index-7e4d12da5ffa0d3dfa43.js.map